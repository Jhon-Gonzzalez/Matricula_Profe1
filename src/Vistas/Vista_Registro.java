...
public class Vista_Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Panel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 40, 100, 50));

        jLabel2.setBackground(new java.awt.Color(255, 255, 255));
        jLabel2.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("Nombre");
        Panel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 30, 100, 50));

        jLabel3.setBackground(new java.awt.Color(255, 255, 255));
        jLabel3.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("Sexo");
        Panel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 90, 100, 50));

        jLabel4.setBackground(new java.awt.Color(255, 255, 255));
        jLabel4.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("Edad");
        Panel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 140, 100, 50));

        jLabel5.setBackground(new java.awt.Color(255, 255, 255));
        jLabel5.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("Curso");
        Panel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 140, 100, 50));

        jLabel8.setBackground(new java.awt.Color(255, 255, 255));
        jLabel8.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 0, 0));
        jLabel8.setText("Titulo");
        Panel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 90, 100, 50));
        ...
        Panel1.add(cmb_Curso, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 150, 130, 30));
        Panel1.add(txt_Id, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 50, 100, 30));

        edad.setForeground(new java.awt.Color(0, 0, 0));
        edad.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos Personales", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        Panel1.add(edad, new org.netbeans.lib.awtextra.AbsoluteConstraints(-80, -30, 310, 190));
        ...
        Panel1.add(cmb_Sexo, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 100, 130, 30));
        ...
        Panel1.add(cmb_Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 110, 140, 30));
        ...
        Panel1.add(Buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 280, -1, -1));
        ...
        Panel1.add(Guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 310, 120, 40));

        Bordes2.setForeground(new java.awt.Color(0, 0, 0));
        Bordes2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Buscar ID", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        Panel1.add(Bordes2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 230, 250, 110));
        Panel1.add(txt_Nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 30, 100, 30));
        Panel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 440, -1, -1));

        Bordes1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, " Datos Profesionles", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        Panel1.add(Bordes1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 20, 310, 200));
        Panel1.add(txt_Buscado, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 280, 100, 30));

        spn_Edad.setModel(new javax.swing.SpinnerNumberModel(0, 0, 120, 1));
        Panel1.add(spn_Edad, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 160, 120, -1));

        getContentPane().add(Panel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 800, 350));
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 370, 770, 180));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 350, 800, 220));
