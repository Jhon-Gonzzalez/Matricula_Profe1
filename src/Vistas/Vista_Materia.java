...
public class Vista_Materia extends javax.swing.JFrame {
    ...
    public void mostrar() {
        ...
        for (int i = 0; i < pos; i++) {
            ...
            Tabla_Estudiantes.setValueAt(listado[i].getSemestre(), x, 3);
            Tabla_Estudiantes.setValueAt(listado[i].getCalendario(), x, 4);
    ...
    private void initComponents() {
        ...
        Panel.add(Guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 340, -1, -1));
        ...
        Tabla_Estudiantes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Materia", "Id Horario", "Materia", "Semestre", "Calendario", "Salon", "Hora", "Fecha"
            }
        ));
        jScrollPane1.setViewportView(Tabla_Estudiantes);

        Panel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, 720, 160));
        ...
        Bordes3.setForeground(new java.awt.Color(0, 0, 0));
        Bordes3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, " Datos Profesionles", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        Panel.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 800, 330));
